...
describe FeelGoodBot do
  ...
  it "accepts complements" do
    post '/complement', complement: "You look nice today."
    assert last_response.ok?
    assert_equal "Thanks for saying, \"You look nice today.\" I really appreciate it.", last_response.body
  end
end
